...
- Clarusway has recently ended up a project that aims to serve as web page. You and your colleagues are assigned to work on this project. The Developer team has done with code and DevOps team is going to deploy the app in production environment using ansible.
...
- Codes written by developers should be pulled from damlab45 Repo into the Jenkins server and sent them to the EC2's from here with Ansible.
